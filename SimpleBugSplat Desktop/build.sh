...
# ---------------------------------------
# This script compiles the SwinGame 
# projects for your Mac or PC.
# The game can then be run using
# the run.sh script.
#
# In Sublime Text you can run this script 
# using the "command + b" keys on Mac or
# the "ctrl + b" keys on Windows.
#
#---------------------------------------
