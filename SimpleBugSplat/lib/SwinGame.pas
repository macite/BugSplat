// SwinGame.pas was generated on 2013-10-04 15:40:25.538800
// 
...
implementation
  ...
  function CreateSprite(layerName, animationName: String; evts: SpriteEventHandler): Sprite; overload;
  begin
    result := sgSprites.CreateSprite(layerName, animationName, evts);
  end;

  function CreateSprite(layerName, animationName: String): Sprite; overload;
  begin
    result := sgSprites.CreateSprite(layerName, animationName);
  end;

  procedure SpriteMoveTo(s: Sprite; const pt: Point2D; inSeconds: Longint);
  begin
    sgSprites.SpriteMoveTo(s, pt, inSeconds);
  end;
